...
public class StatusEffectInstantConvertShellToTeeth : StatusEffectInstant
{
    [SerializeField]
    public StatusEffectData TeethEffect;
    ...
    public override IEnumerator Process()
    {
        ...
        var hit = new Hit(instantTakeShell.target, instantTakeShell.target, 0)
        {
            canRetaliate = false,
            countsAsHit = false
        };

        hit.AddStatusEffect(instantTakeShell.TeethEffect, amount);
